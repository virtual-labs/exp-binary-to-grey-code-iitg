...
//            Connector : [ "Flowchart", { curviness:80 } ],
            PaintStyle : { strokeStyle:'green', lineWidth:5 },
        ...
        jsPlumbInstance.bind("beforeDrop", function(params) {
            ...
            if(sourceEndPoint.getParameter('acceptType') !== targetEndPoint.getParameter('type')){
                //alert("You are trying to make an invalid connection.");
                //return false;
                if((sourceEndPointChannel === 'r0') && (targetEndPointChannel === 'c18') || (sourceEndPointChannel === 'r1') && (targetEndPointChannel === 'c19'))
                {
                   
                    return true;
                }
                else if((sourceEndPointChannel === 'r1') && (targetEndPointChannel === 'c21') || (sourceEndPointChannel === 'r2') && (targetEndPointChannel === 'c22')){
                    return true;
                }
                else if((sourceEndPointChannel === 'r2') && (targetEndPointChannel === 'r25') || (sourceEndPointChannel === 'r3') && (targetEndPointChannel === 'r26'))
                 {
                    return true;
                 } 
                else if((sourceEndPointChannel === 'r3') && (targetEndPointChannel === 'r7') || (sourceEndPointChannel === 'r4') && (targetEndPointChannel === 'c20'))
                 {
                    return true;
                 }
                else if((sourceEndPointChannel === 'r5') && (targetEndPointChannel === 'c23') || (sourceEndPointChannel === 'r6') && (targetEndPointChannel === 'r27'))
                 {
                    return true;
                 } 
